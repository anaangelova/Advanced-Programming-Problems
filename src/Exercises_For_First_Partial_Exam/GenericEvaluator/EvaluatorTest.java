package Exercises_For_First_Partial_Exam.GenericEvaluator;
...
class EvaluatorBuilder{ //somewhat of a utility class
    public static <T extends Comparable<T>> IEvaluator<T> build (String operator){ //vo ovoj metod vsushnost gi imame implementaciite na funkcionalniot interfejs
...
class Evaluator{
    public static <T extends Comparable<T>> boolean evaluateExpression (T left, T right, String operator){
        IEvaluator<T> evaluator= EvaluatorBuilder.build(operator); //dobivame konkretna implementacija na interfejsot IEvalautor<T>
