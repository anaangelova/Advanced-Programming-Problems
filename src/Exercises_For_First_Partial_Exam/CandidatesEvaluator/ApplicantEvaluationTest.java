package Exercises_For_First_Partial_Exam.CandidatesEvaluator;
    ...
    public static Evaluator build(Evaluator.TYPE type) throws InvalidEvaluation {
        switch (type) {
            case NO_CRIMINAL_RECORD -> {
                return applicant -> !applicant.hasCriminalRecord(); //ova e konkretna implementacija na evaluate metodot od Evaluator interfejsot
            }
